...
### Это небольшая утилита для поиска файлов-дубликатов
...
- -d {directory} : путь к папке, в которой будет выполняться поиск файлов-дубликатов.

3. Результат поиска в виде списка файлов выводится в консоль.
