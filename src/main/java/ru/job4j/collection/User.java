...
public class User {
    ...
    public static void main(String[] args) {
         ...
         * Объекты попали в один и тотже бакет, т.к после переопределения метода hashCode()
         * вычисленные значения key.hashCode() и соответственно hash(key.hashCode())
         * будут одинаковы.
         ...
         * в качестве следующей ноды в односвязный список, а не перезаписывает
         * значение поля первой ноды.
